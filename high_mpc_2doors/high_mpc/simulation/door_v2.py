...
class Door_v2(object):
    ...
    def __init__(self, center_point, dt):#, rand_k):
        ...
        # initial state
        self._motion_range = np.array([0.1, 0.2]) #0.5
        self._motion_speed = np.array([0.25, 0.35]) #0.5
        self._motion_angle = np.array([0,np.pi/6])
        ...
        self.height = 0.4  # gate heiht (for visualization only)
