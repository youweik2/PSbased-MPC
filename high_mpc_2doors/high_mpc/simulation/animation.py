...
class SimVisual(object):
    ...
    def __init__(self, env):
        ...
        self.start_point = env.start_point          # e.g., np.array([2.0, 0.0, 2.0])
        self.frames = []
        #
        # create figure
        ...
        self.ax_pos.plot([], [], '-r', label='quad_x')  
        self.ax_pos.plot([], [], '-g', label='quad_y')  
        self.ax_pos.plot([], [], '-b', label='quad_z')  
        self.ax_pos.plot([], [], '--r', label='door_x')  
        self.ax_pos.plot([], [], '--g', label='door_y')  
        self.ax_pos.plot([], [], '--b', label='door_z')  
        self.ax_pos.legend()  
        ...
        self.ax_vel.plot([], [], '-r', label='quad_vx')  
        self.ax_vel.plot([], [], '-g', label='quad_vy')  
        self.ax_vel.plot([], [], '-b', label='quad_vz')  
        self.ax_vel.plot([], [], '--r', label='door_vx')  
        self.ax_vel.plot([], [], '--g', label='door_vy')  
        self.ax_vel.plot([], [], '--b', label='door_vz')  
        self.ax_vel.legend()  # 
        ...
        self.ax_att.plot([], [], '-r', label='quad_ax')  
        self.ax_att.plot([], [], '-g', label='quad_ay')  
        self.ax_att.plot([], [], '-b', label='quad_az')  
        self.ax_att.plot([], [], '--r', label='door_ax')  
        self.ax_att.plot([], [], '--g', label='door_ay')  
        self.ax_att.plot([], [], '--b', label='door_az') 
        self.ax_att.legend()  
        ...
        self.ax_act.set_title('Action') 
        self.ax_act.plot([], [], '-k', label='quad_thrust')  
        self.ax_act.plot([], [], '-r', label='quad_wx') 
        self.ax_act.plot([], [], '-g', label='quad_wy') 
        self.ax_act.plot([], [], '-b', label='quad_wz') 
        self.ax_act.legend()  
        ...
        self.l_door_pred_traj, = self.ax_3d.plot([], [], [], 'ko')
        #
        ...
        self.l_door, = self.ax_3d.plot([], [], [], 'g', linewidth=2)
        self.l_door_edge1, = self.ax_3d.plot([], [], [], 'g', linewidth=2)
        self.l_door_edge2, = self.ax_3d.plot([], [], [], 'g', linewidth=2)
        self.l_door_edge3, = self.ax_3d.plot([], [], [], 'g', linewidth=2)
        self.l_door_edge4, = self.ax_3d.plot([], [], [], 'g', linewidth=2)
        #
        ...
        #
        self.ax_3d.scatter(self.start_point[0], self.start_point[1], self.start_point[2], marker='o', color='r')
    ...
    def reset_buffer(self, ):
        ...
        self.door_pos, self.door_vel, self.door_att = [], [], []
        self.quad_hist = []
    ...
    def init_animate(self,):
        ...
        self.l_door_pred_traj.set_data([], [])
        self.l_door_pred_traj.set_3d_properties([])
        ...
        self.l_door.set_data([], [])
        self.l_door.set_3d_properties([])

        self.l_door_edge1.set_data([], [])
        self.l_door_edge1.set_3d_properties([])
        self.l_door_edge2.set_data([], [])
        self.l_door_edge2.set_3d_properties([])
        self.l_door_edge3.set_data([], [])
        self.l_door_edge3.set_3d_properties([])
        self.l_door_edge4.set_data([], [])
        self.l_door_edge4.set_3d_properties([])
        ...
        return self.l_quad_px, self.l_quad_py, self.l_quad_pz, \
            ...
            self.l_door_pred_traj, self.l_door_px, self.l_door_py, self.l_door_pz, \
            self.l_door_vx, self.l_door_vy, self.l_door_vz, \
            self.l_door_ax, self.l_door_ay, self.l_door_az, \
            self.l_door_edge1, self.l_door_edge2, self.l_door_edge3, self.l_door_edge4, 
    ...
    def update(self, data_info):
        ...
        pend_obs = info["door_obs"]
        door_obs = info["door2_obs"]
        pend_corners = info["door_corners"]
        door_corners = info["door2_corners"]
        pred_quad_traj = info["pred_quad_traj"]
        pred_pend_traj = info["pred_door_traj1"]
        pred_door_traj = info["pred_door_traj2"]
        opt_t = info["opt_t"]
        ...
        if update:
            ...
            self.door_pos.append(door_obs[0:3])
            self.door_att.append(door_obs[3:6])
            self.door_vel.append(door_obs[6:9])
        ...
        if len(self.ts) == 0:
            ...
            door_pos_arr = np.array(self.door_pos)
            self.l_door_px.set_data(self.ts, pend_pos_arr[:, 0])
            self.l_door_py.set_data(self.ts, pend_pos_arr[:, 1])
            self.l_door_pz.set_data(self.ts, pend_pos_arr[:, 2])
            #
            door_vel_arr = np.array(self.door_vel)
            self.l_door_vx.set_data(self.ts, pend_vel_arr[:, 0])
            self.l_door_vy.set_data(self.ts, pend_vel_arr[:, 1])
            self.l_door_vz.set_data(self.ts, pend_vel_arr[:, 2])
            #
            door_att_arr = np.array(self.door_att)
            self.l_door_ax.set_data(self.ts, pend_att_arr[:, 0])
            self.l_door_ay.set_data(self.ts, pend_att_arr[:, 1])
            self.l_door_az.set_data(self.ts, pend_att_arr[:, 2])
            ...
            if quad_pos_arr[-1, 0] <= 2.0:
                ...
                self.l_door_pred_traj.set_data(pred_door_traj[opt_idx, 0], pred_door_traj[opt_idx, 1])
                #self.l_pend_pred_traj.set_3d_properties(pred_pend_traj[opt_idx, 2])
            
            #
            self.l_pend.set_data([self.start_point[0], pend_obs[kPosX]], [self.start_point[1], pend_obs[kPosY]] )
            self.l_pend.set_3d_properties([self.start_point[2], pend_obs[kPosZ]])
            ...
            d1, d2, d3, d4 = door_corners 

            self.l_door_edge1.set_data([d1[0], d2[0]], [d1[1], d2[1]])
            self.l_door_edge1.set_3d_properties([d1[2], d2[2]])
            self.l_door_edge2.set_data([d2[0], d2[0]], [d2[1], d4[1]])
            self.l_door_edge2.set_3d_properties([d2[2], d4[2]])
            self.l_door_edge3.set_data([d4[0], d3[0]], [d4[1], d3[1]])
            self.l_door_edge3.set_3d_properties([d4[2], d3[2]])
            self.l_door_edge4.set_data([d3[0], d1[0]], [d3[1], d1[1]])
            self.l_door_edge4.set_3d_properties([d3[2], d1[2]])            
